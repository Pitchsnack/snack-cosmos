...
export function StartupListItem({
  ...
  return (
    <button
      ...
      onClick={onSelect}
      className={cn(
        "group h-[260px] w-full overflow-hidden rounded-lg border bg-card p-3 text-left shadow-card transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60",
